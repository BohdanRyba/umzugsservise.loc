                ...
                <div class="col-sm-12">
                    <div class="tab-wrapper">
                        <ul class="tab-menu-blog">
                            ...
                            <li> Раздел второй</li>
                            <li> Раздел при наведении</li>
                            <li> Раздел 4</li>
                            <li> Раздел длинное название раздела возможно очень длинное название</li>
                            <li> Раздел номер шесть</li>
                        </ul>
                                ...
                                <div class="item">
                                    <div class="col" data-aos="zoom-out" data-aos-delay="100" data-aos-once="true">
                                        <div class="block-article">
                                            ...
                                            <div class="foto">
                                                <a href="/BlogItem.php">
                                                    <img src="{{asset('front')}}/img/blog/block2/foto1.png" alt="">
                                                </a>
                                            </div>
