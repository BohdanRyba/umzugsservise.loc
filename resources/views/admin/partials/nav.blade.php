...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="{{adminLocaleLink('/')}}">Start Bootstrap</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        @else
            @include('admin.partials.projects-none')
        @endif
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link" href="{{localeLink('/logout') }}" onclick="event.preventDefault();
